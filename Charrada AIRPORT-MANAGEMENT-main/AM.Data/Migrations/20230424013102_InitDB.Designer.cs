...
namespace AM.Data.Migrations
{
    ...
    [Migration("20230424013102_InitDB")]
            ...
            modelBuilder.Entity("FlightPassenger", b =>
                {
                    ...
                    b.Property<DateTime>("passengersBirthDate")
                        .HasColumnType("datetime2");

                    b.HasKey("FlightsFlightId", "passengersBirthDate");

                    b.HasIndex("passengersBirthDate");
            ...
            modelBuilder.Entity("FlightPassenger", b =>
                {
                    ...
                    b.HasOne("AM.Core.Domain.Passenger", null)
                        .WithMany()
                        .HasForeignKey("passengersBirthDate")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
